...
public class StyleRenderer implements Renderer {
    ...
    private static final String TH_TD_CSS
            = "th, td {\n"
            ...
            + "      text-align: center;\n"
            + "    }";
    private static final String DOT_UI_ICON_CSS 
            = ".ui-icon {\n" 
            + "      width: 16px;\n" 
            + "      height: 16px;\n" 
            + "      display: inline-block;\n" 
            + "    }";
    private static final String DOT_UI_ICON_CHECK_CSS 
            = ".ui-icon-check {\n" 
            + "      background-color: green;\n" 
            + "    }";
    private static final String DOT_UI_ICON_CLOSE_CSS 
            = ".ui-icon-close {\n" 
            + "      background-color: red;\n" 
            + "    }";
    private static final String DOT_IU_STATE_DISABLED_CSS 
            = ".ui-state-disabled {\n" 
            + "      color: #999;\n" 
            + "    }";
    ...
    private final Node<String> style = new Node.Builder("style")
            .content(new StringBuilder()
                    ...
                    .append(DOT_IU_STATE_DISABLED_CSS)
                    .append('\n')
                    .toString())
            .build();
